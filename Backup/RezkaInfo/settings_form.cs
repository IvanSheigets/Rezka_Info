    ...
    public partial class settings_form : Form
    {
        ...
        private void settings_form_Load(object sender, EventArgs e)
        {
            ...
            if (readKey != null)
            {
                ...
                if (m_iRegim == 1)
                    ...
                    checkBox_RezkaMaster.Checked = true;
            }
            else
            {
                m_iRegim = -1;
                ...
                checkBox_RezkaMaster.Checked = false;
            }
        ...
        private void checkBox_See_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox_See.Checked == true)
            {
                ...
                saveKey.SetValue("Type_app", "0"); // 0 - просмотр 1-редактирование  2-резка 3-резка мастер
                saveKey.Close(); 
            }
        ...
        private void checkBox_Change_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox_Change.Checked == true)
            {
                ...
                RegistryKey saveKey = Registry.LocalMachine.CreateSubKey("software\\rezka_info");
                saveKey.SetValue("Type_app", "1"); // 0 - просмотр 1-редактирование  2-резка 3-резка мастер
                saveKey.Close(); 
            }
        }
        ...
        private void checkBox_Rezka_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox_Rezka.Checked == true)
            {
                ...
                RegistryKey saveKey = Registry.LocalMachine.CreateSubKey("software\\rezka_info");
                saveKey.SetValue("Type_app", "2"); // 0 - просмотр 1-редактирование  2-резка 3-резка мастер
                saveKey.Close();
            }
        }

        private void checkBox_RezkaMaster_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox_RezkaMaster.Checked == true)
            {
                checkBox_See.Checked = false;
                checkBox_Change.Checked = false;
                checkBox_Rezka.Checked = false;
                ...
                RegistryKey saveKey = Registry.LocalMachine.CreateSubKey("software\\rezka_info");
                saveKey.SetValue("Type_app", "3"); // 0 - просмотр 1-редактирование  2-резка 3-резка мастер
                saveKey.Close();
            }
        }
